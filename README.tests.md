...
podman run -ti \
	...
	quay.io/openshift-kni/numaresources-operator-tests:5.1.999-snapshot
```
...
```bash
export E2E_IMAGE_URL=quay.io/openshift-kni/numaresources-operator-tests:5.1.999-snapshot
podman run -ti \
	-v $KUBECONFIG:/kubeconfig:z \
	-e KUBECONFIG=/kubeconfig \
	-e E2E_NROP_INSTALL_SKIP_KC=true \
...
```bash
export CNF_TESTS_URL="quay.io/openshift-kni/cnf-tests:5.1.0"
podman run -ti \
	-v $KUBECONFIG:/kubeconfig:z \
	-e KUBECONFIG=/kubeconfig \
