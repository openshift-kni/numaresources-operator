...
FROM quay.io/konflux-ci/yq:latest@sha256:47c00d3d096c05a89e0caeee6d10c66d8a126486f634ccba9c1f2817a5273997 AS overlay
...
LABEL cpe="cpe:/a:redhat:openshift:4.19::el9"
...
LABEL operators.operatorframework.io.bundle.channels.v1="${OPENSHIFT_VERSION},stable"
