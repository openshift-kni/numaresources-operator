...
overlay_release()
{
    ...
    local version="4.12.17"
    local name="numaresources-operator"
    local name_version="$name.v$version"
    local skip_range=">=4.11.0 <4.12.16"
    local replaces="numaresources-operator.v4.12.16"
    local annotations='
  ...
  "OpenShift Platform Plus"
    ...
    # dont need 'replaces' for first release in a new channel (4.12.0)
    # yq e -i "del(.spec.replaces)" $ARG_CSV_FILE

    # use this from 4.12.1 onwards
