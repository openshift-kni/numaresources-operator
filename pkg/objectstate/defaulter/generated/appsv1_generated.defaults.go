...
func SetObjectDefaults_StatefulSet(in *appsv1.StatefulSet) {
	...
	for i := range in.Spec.VolumeClaimTemplates {
		...
		SetDefaults_PersistentVolumeClaim(a)
		SetDefaults_PersistentVolumeClaimSpec(&a.Spec)
		SetDefaults_ResourceList(&a.Spec.Resources.Limits)
		SetDefaults_ResourceList(&a.Spec.Resources.Requests)
		SetDefaults_ResourceList(&a.Status.Capacity)
		SetDefaults_ResourceList(&a.Status.AllocatedResources)
	}
}
