...
func (mf Manifests) Clone() Manifests {
	return Manifests{
		...
		DenyAllNetworkPolicy:   mf.DenyAllNetworkPolicy.DeepCopy(),
...
func GetManifests(namespace string) (Manifests, error) {
	...
	mf.DenyAllNetworkPolicy, err = manifests.DenyAllNetworkPolicy(namespace)
	if err != nil {
		return mf, err
	}

	mf.APIserverNetworkPolicy, err = manifests.APIserverNetworkPolicy(namespace)
	if err != nil {
		return mf, err
	}
