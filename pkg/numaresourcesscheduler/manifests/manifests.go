...
func DenyAllNetworkPolicy(namespace string) (*networkingv1.NetworkPolicy, error) {
...
func APIserverNetworkPolicy(namespace string) (*networkingv1.NetworkPolicy, error) {
	obj, err := loadObject(filepath.Join("yaml", "networkpolicy.apiserver.yaml"))
	if err != nil {
		return nil, err
	}
