...
const (
	...
	StableSupportSince  = "4.18.23"
	NightlySupportSince = "4.18.0-0.nightly-2025-09-03-101304" // *** according to OCP verification:wq
	CISupportSince      = "4.18.0-0.ci-2025-09-06-131154"      // *** the earliest that was found available at time of writing this
)
