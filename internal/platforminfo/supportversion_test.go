...
func TestDecodeMinimumVersion(t *testing.T) {
	nightly, _ := platform.ParseVersion("4.16.0-0.nightly-2025-08-04-12")
	ci, _ := platform.ParseVersion("4.16.0-0.ci-2025-08-04-12")
	stable, _ := platform.ParseVersion("4.16.0")
	unrecognized, _ := platform.ParseVersion("4.16.0-unknown")
...
func TestIsVersionEnoughForPodresourcesListFilterActivePods(t *testing.T) {
	nightlyGreater, _ := platform.ParseVersion("4.16.0-0.nightly-2025-09-29-154810")
	ciGreater, _ := platform.ParseVersion("4.16.0-0.ci-2025-10-00-000000")
	stableGreater, _ := platform.ParseVersion("4.16.50")

	unsupportedNightly, _ := platform.ParseVersion("4.16.0-0.nightly-2025-08-04-150000")
	unsupportedStable, _ := platform.ParseVersion("4.16.0")
