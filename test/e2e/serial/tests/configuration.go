...
var _ = Describe("[serial][disruptive] numaresources configuration management", Serial, Label("disruptive"), Label("feature:config"), func() {
	...
	Context("cluster has at least one suitable node", func() {
		...
		It("[replaces-47674][images][tier2] should be able to modify the configurable values under the NUMAResourcesOperator CR", Label("images", "tier2"), Label("feature:tmp_b52958"), func(ctx context.Context) {
