...
CRD_MACHINE_CONFIG_POOL_URL="https://raw.githubusercontent.com/openshift/api/refs/heads/release-4.20/payload-manifests/crds/0000_80_machine-config_01_machineconfigpools.crd.yaml"
# Specify the URL link to the kubeletconfig CRD
CRD_KUBELET_CONFIG_URL="https://raw.githubusercontent.com/openshift/api/refs/heads/release-4.20/payload-manifests/crds/0000_80_machine-config_01_kubeletconfigs.crd.yaml"
