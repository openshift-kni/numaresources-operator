...
// pin to openshift 4.18
replace (
	github.com/openshift/api => github.com/openshift/api v0.0.0-20250410062700-d6c84c55a124
	github.com/openshift/hypershift/api => github.com/openshift/hypershift/api v0.0.0-20250413125743-9592fdc5c786
	github.com/openshift/machine-config-operator => github.com/openshift/machine-config-operator v0.0.1-0.20250407210212-20f26604558b
)
