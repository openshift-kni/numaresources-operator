...
require (
	...
	github.com/k8stopologyawareschedwg/deployer v0.8.0
	...
	github.com/k8stopologyawareschedwg/resource-topology-exporter v0.8.1
...
require (
	...
	k8s.io/kube-scheduler v0.24.7 // indirect
