...
require (
	...
	github.com/k8stopologyawareschedwg/deployer v0.0.11-0.20211116090120-a65f39021222
...
require (
	...
	github.com/openshift/machine-config-operator v0.0.1-0.20211105081319-76d6155c1dab // indirect
