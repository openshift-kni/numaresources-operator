...
require (
	...
	github.com/openshift/api v0.0.0-20260107103503-6d35063ca179 // release-4.18
...
replace (
	// Use client-go version that uses structured-merge-diff v6 (required by k8s.io 0.34.x).
