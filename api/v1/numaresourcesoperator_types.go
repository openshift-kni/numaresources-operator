...
// +kubebuilder:validation:XValidation:rule="has(self.metadata.name) && self.metadata.name == 'numaresourcesoperator'",message="This is a singleton resource; the object name must be 'numaresourcesoperator'."
